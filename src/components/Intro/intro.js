...
export default function Intro() {
  return (
   <Flex
      ...
      zIndex="1"
    >
      <Box pos="absolute" top="-30%" left="-5%" transform="rotate(-30deg) translateY(-50%)" zIndex="-1">
        <Text fontSize="600px" lineHeight="0.8em" letterSpacing="-5px" fontWeight="900" color="rgba(0, 0, 0, 0.04)">strategy<br />design<br />progress<br />statements</Text>
      </Box>
      <Container maxW="container.xl" display="flex" flexWrap="wrap">
        <Flex 
          ...
          width="50%"
        >
          <Heading as="h1"  display="flex" flexWrap="wrap" gap="10px" alignItems="center" fontWeight="500" letterSpacing="-4px" lineHeight="normal" color="blackAlpha.900" fontSize="65px" >
            Haris Khan
            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 48 49" fill="none" class="svg replaced-svg">
